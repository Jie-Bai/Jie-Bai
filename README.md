...
Recipient, Excellent Prize of CAS President Scholarship (中国科学院院长奖获得者).
...
- **Bai J**, Niu Z*, Bi K, Wang L*, et al (2024). Toward An Advanced Method for Full-Waveform Hyperspectral LiDAR Data Processing. **IEEE Transactions on Geoscience and Remote Sensing**, 62: 1-16.  (TOP).
...
- **Bai, J.**, Gao, S.*, Niu, Z., Zhang, C., Bi, K., Sun, G., and Huang, Y. (2021). A Novel Algorithm for Leaf Incidence Angle Effect Correction of Hyperspectral LiDAR. **IEEE Transactions on Geoscience and Remote Sensing**, 60, 1-9.  (TOP).
